...
public final class EventsServiceGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<events.TypeArg,
            events.Data> getSubscribeMethod;

    @RpcMethod(
            fullMethodName = SERVICE_NAME + '/' + "Subscribe",
            requestType = events.TypeArg.class,
            responseType = Data.class,
            methodType = MethodDescriptor.MethodType.BIDI_STREAMING)
    public static MethodDescriptor<events.TypeArg,
            Data> getSubscribeMethod() {
        MethodDescriptor<events.TypeArg, events.Data> getSubscribeMethod;
            ...
            synchronized (EventsServiceGrpc.class) {
                if ((getSubscribeMethod = EventsServiceGrpc.getSubscribeMethod) == null) {
                    EventsServiceGrpc.getSubscribeMethod = getSubscribeMethod =
                            MethodDescriptor.<events.TypeArg, events.Data>newBuilder()
                                    .setType(MethodDescriptor.MethodType.BIDI_STREAMING)
                                    .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Subscribe"))
                                    .setSampledToLocalTracing(true)
                                    .setRequestMarshaller(ProtoUtils.marshaller(
                                            events.TypeArg.getDefaultInstance()))
                                    .setResponseMarshaller(ProtoUtils.marshaller(
                                            events.Data.getDefaultInstance()))
    ...
    public static abstract class EventsServiceImplBase implements io.grpc.BindableService {
        ...
        /**
         */
        public io.grpc.stub.StreamObserver<events.TypeArg> subscribe(
                io.grpc.stub.StreamObserver<events.Data> responseObserver) {
